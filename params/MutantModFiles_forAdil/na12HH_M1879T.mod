...
PARAMETER {
	...
	tha  =  -22	(mV)		: v 1/2 for act	
	qa   = 5.41	(mV)		: act slope (4.5)		
	Ra   = 0.3282 (/ms)		: open (v)		
	Rb   = 0.1 	(/ms)		: close (v)		

	thi1  = -57.2	(mV)		: v 1/2 for inact 	
	thi2  = -57.2 	(mV)		: v 1/2 for inact 	
	...
	Rd   = 0.013285 	(/ms)		: inact (v)	
	qq   = 10        (mV)
	tq   = -55      (mV)

	thinf  = -30.2 :-48.4785 	(mV)		: inact inf slope	
	qinf  = 7.69	(mV)		: inact inf slope 

        vhalfs=-37.2	(mV)		: slow inact.
